...
import com.ertelecom.carrental.model.view.CarModelView;
...
public class CarModelController {
    ...
    public DataResponse get() {
        ...
        response.result = carModelService.load()
                .stream()
                .map((s)-> new CarModelView(s))
    ...
    @RequestMapping(value = "/edit", method = RequestMethod.GET,
            produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<CarModel> getForEdit(@RequestParam("id") long id) {
        CarModel result = carModelService.loadById(id).orElse(null);
    ...
    @RequestMapping(value = "/edit", method = RequestMethod.POST,
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    public CarModel edit(@Valid @RequestBody CarModel carModel) {
        carModel = carModelService.save(carModel);
        return carModel;
    }
    ...
    public ResponseEntity<Long> delete(@RequestParam("id") long id) {
        return new ResponseEntity<>(id, carModelService.deleteById(id) ? HttpStatus.OK : HttpStatus.GONE);
    }
